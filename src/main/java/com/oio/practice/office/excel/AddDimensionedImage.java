...
public class AddDimensionedImage {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String outputFile = args[1] + "/image " + Instant.now().getEpochSecond() + " .xlsx";

        String path = "C:\\Users\\Qiongchao\\Downloads\\test3.xlsx";
        try (FileInputStream is = new FileInputStream(path); final Workbook workbook = new XSSFWorkbook(is);
            ...
            new AddDimensionedImage().addImageToSheet("X37", sheet, sheet.createDrawingPatriarch(),
                    new File(imageFile).toURI().toURL(), 57, 41.3,
                    AddDimensionedImage.OVERLAY_ROW_AND_COLUMN);
            workbook.write(fos);
        }
    }
